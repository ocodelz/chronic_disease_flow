<template>
	<scroll-view scroll-y class="wrap">
		<free-title title="数据管理"></free-title>
				...
				<view class="scroll-table" v-if="table.length">
					<scroll-view class="scroll-table-container" scroll-x :show-scrollbar="true">
						<view class="scroll-table-content">
							...
							<view class="scroll-table-item">类型</view>
							<view class="scroll-table-item">时间</view>
							<view class="scroll-table-item">姓名</view>
							<view class="scroll-table-item">年龄</view>
							<view class="scroll-table-item" style="width: 1.5rem;">现住址</view>
							<view class="scroll-table-item">上传状态</view>
							<view class="scroll-table-item">备注</view>
						</view>
